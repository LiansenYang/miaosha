...
import com.yangls.miaosha.model.OrderInfoExample.Criteria;
import com.yangls.miaosha.model.OrderInfoExample.Criterion;
...
public class OrderInfoSqlProvider {
    ...
    public String insertSelective(OrderInfo record) {
        ...
        if (record.getDeliveryAddrId() != null) {
            sql.VALUES("delivery_addr_id", "#{deliveryAddrId,jdbcType=BIGINT}");
        }
        ...
        if (record.getOrderChannel() != null) {
            sql.VALUES("order_channel", "#{orderChannel,jdbcType=TINYINT}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getDeliveryAddrId() != null) {
            sql.SET("delivery_addr_id = #{record.deliveryAddrId,jdbcType=BIGINT}");
        }
        ...
        if (record.getOrderChannel() != null) {
            sql.SET("order_channel = #{record.orderChannel,jdbcType=TINYINT}");
        }
        ...
        if (record.getPayDate() != null) {
            sql.SET("pay_date = #{record.payDate,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByPrimaryKeySelective(OrderInfo record) {
        ...
        if (record.getDeliveryAddrId() != null) {
            sql.SET("delivery_addr_id = #{deliveryAddrId,jdbcType=BIGINT}");
        }
        ...
        if (record.getOrderChannel() != null) {
            sql.SET("order_channel = #{orderChannel,jdbcType=TINYINT}");
        }
